...
const union AnimCmd *const sAnimTable_Following[] = {
    ...
    [ANIM_STD_FACE_SOUTHWEST] = sAnim_FaceSouth,
    [ANIM_STD_FACE_SOUTHEAST] = sAnim_FaceSouth,
    [ANIM_STD_FACE_NORTHWEST] = sAnim_FaceNorth2F,
    [ANIM_STD_FACE_NORTHEAST] = sAnim_FaceNorth2F,
    [ANIM_STD_GO_SOUTHWEST] = sAnim_GoSouth2F,
    [ANIM_STD_GO_SOUTHEAST] = sAnim_GoSouth2F,
    [ANIM_STD_GO_NORTHWEST] = sAnim_GoNorth2F,
    [ANIM_STD_GO_NORTHEAST] = sAnim_GoNorth2F,
    [ANIM_STD_GO_FAST_SOUTHWEST] = sAnim_GoFastSouth2F,
    [ANIM_STD_GO_FAST_SOUTHEAST] = sAnim_GoFastSouth2F,
    [ANIM_STD_GO_FAST_NORTHWEST] = sAnim_GoFastNorth2F,
    [ANIM_STD_GO_FAST_NORTHEAST] = sAnim_GoFastNorth2F,
