...
#define MOVEMENT_ACTION_JUMP_2_SOUTHWEST                0xAA
#define MOVEMENT_ACTION_JUMP_2_SOUTHEAST                0xAB
#define MOVEMENT_ACTION_JUMP_2_NORTHWEST                0xAC
#define MOVEMENT_ACTION_JUMP_2_NORTHEAST                0xAD
#define MOVEMENT_ACTION_WALK_FAST_SOUTHWEST             0xAE
#define MOVEMENT_ACTION_WALK_FAST_SOUTHEAST             0xAF
#define MOVEMENT_ACTION_WALK_FAST_NORTHWEST             0xB0
#define MOVEMENT_ACTION_WALK_FAST_NORTHEAST             0xB1
#define MOVEMENT_ACTION_WALK_IN_PLACE_SLOW_SOUTHWEST    0xB2
#define MOVEMENT_ACTION_WALK_IN_PLACE_SLOW_SOUTHEAST    0xB3
#define MOVEMENT_ACTION_WALK_IN_PLACE_SLOW_NORTHWEST    0xB4
#define MOVEMENT_ACTION_WALK_IN_PLACE_SLOW_NORTHEAST    0xB5
#define MOVEMENT_ACTION_WALK_IN_PLACE_NORMAL_SOUTHWEST  0xB6
#define MOVEMENT_ACTION_WALK_IN_PLACE_NORMAL_SOUTHEAST  0xB7
#define MOVEMENT_ACTION_WALK_IN_PLACE_NORMAL_NORTHWEST  0xB8
#define MOVEMENT_ACTION_WALK_IN_PLACE_NORMAL_NORTHEAST  0xB9
#define MOVEMENT_ACTION_WALK_IN_PLACE_FAST_SOUTHWEST    0xBA
#define MOVEMENT_ACTION_WALK_IN_PLACE_FAST_SOUTHEAST    0xBB
#define MOVEMENT_ACTION_WALK_IN_PLACE_FAST_NORTHWEST    0xBC
#define MOVEMENT_ACTION_WALK_IN_PLACE_FAST_NORTHEAST    0xBD
#define MOVEMENT_ACTION_WALK_IN_PLACE_FASTEST_SOUTHWEST 0xBE
#define MOVEMENT_ACTION_WALK_IN_PLACE_FASTEST_SOUTHEAST 0xBF
#define MOVEMENT_ACTION_WALK_IN_PLACE_FASTEST_NORTHWEST 0xC0
#define MOVEMENT_ACTION_WALK_IN_PLACE_FASTEST_NORTHEAST 0xC1
#define MOVEMENT_ACTION_WALK_FASTEST_SOUTHWEST          0xC2
#define MOVEMENT_ACTION_WALK_FASTEST_SOUTHEAST          0xC3
#define MOVEMENT_ACTION_WALK_FASTEST_NORTHWEST          0xC4
#define MOVEMENT_ACTION_WALK_FASTEST_NORTHEAST          0xC5
#define MOVEMENT_ACTION_PLAYER_RUN_SOUTHWEST            0xC6
#define MOVEMENT_ACTION_PLAYER_RUN_SOUTHEAST            0xC7
#define MOVEMENT_ACTION_PLAYER_RUN_NORTHWEST            0xC8
#define MOVEMENT_ACTION_PLAYER_RUN_NORTHEAST            0xC9
#define MOVEMENT_ACTION_RIDE_WATER_CURRENT_SOUTHWEST    0xCA
#define MOVEMENT_ACTION_RIDE_WATER_CURRENT_SOUTHEAST    0xCB
#define MOVEMENT_ACTION_RIDE_WATER_CURRENT_NORTHWEST    0xCC
#define MOVEMENT_ACTION_RIDE_WATER_CURRENT_NORTHEAST    0xCD
#define MOVEMENT_ACTION_JUMP_SOUTHWEST                  0xCE
#define MOVEMENT_ACTION_JUMP_SOUTHEAST                  0xCF
#define MOVEMENT_ACTION_JUMP_NORTHWEST                  0xD0
#define MOVEMENT_ACTION_JUMP_NORTHEAST                  0xD1
#define MOVEMENT_ACTION_JUMP_IN_PLACE_SOUTHWEST         0xD2
#define MOVEMENT_ACTION_JUMP_IN_PLACE_SOUTHEAST         0xD3
#define MOVEMENT_ACTION_JUMP_IN_PLACE_NORTHWEST         0xD4
#define MOVEMENT_ACTION_JUMP_IN_PLACE_NORTHEAST         0xD5
#define MOVEMENT_ACTION_JUMP_IN_PLACE_SOUTHWEST_NORTHEAST 0xD6
#define MOVEMENT_ACTION_JUMP_IN_PLACE_SOUTHEAST_NORTHWEST 0xD7
#define MOVEMENT_ACTION_JUMP_IN_PLACE_NORTHWEST_SOUTHEAST 0xD8
#define MOVEMENT_ACTION_JUMP_IN_PLACE_NORTHEAST_SOUTHWEST 0xD9
#define MOVEMENT_ACTION_JUMP_SPECIAL_SOUTHWEST          0xDA
#define MOVEMENT_ACTION_JUMP_SPECIAL_SOUTHEAST          0xDB
#define MOVEMENT_ACTION_JUMP_SPECIAL_NORTHWEST          0xDC
#define MOVEMENT_ACTION_JUMP_SPECIAL_NORTHEAST          0xDD
#define MOVEMENT_ACTION_ACRO_WHEELIE_FACE_SOUTHWEST     0xDE
#define MOVEMENT_ACTION_ACRO_WHEELIE_FACE_SOUTHEAST     0xDF
#define MOVEMENT_ACTION_ACRO_WHEELIE_FACE_NORTHWEST     0xE0
#define MOVEMENT_ACTION_ACRO_WHEELIE_FACE_NORTHEAST     0xE1
#define MOVEMENT_ACTION_ACRO_POP_WHEELIE_SOUTHWEST      0xE2
#define MOVEMENT_ACTION_ACRO_POP_WHEELIE_SOUTHEAST      0xE3
#define MOVEMENT_ACTION_ACRO_POP_WHEELIE_NORTHWEST      0xE4
#define MOVEMENT_ACTION_ACRO_POP_WHEELIE_NORTHEAST      0xE5
#define MOVEMENT_ACTION_ACRO_END_WHEELIE_FACE_SOUTHWEST 0xE6
#define MOVEMENT_ACTION_ACRO_END_WHEELIE_FACE_SOUTHEAST 0xE7
#define MOVEMENT_ACTION_ACRO_END_WHEELIE_FACE_NORTHWEST 0xE8
#define MOVEMENT_ACTION_ACRO_END_WHEELIE_FACE_NORTHEAST 0xE9
#define MOVEMENT_ACTION_ACRO_WHEELIE_HOP_FACE_SOUTHWEST 0xEA
#define MOVEMENT_ACTION_ACRO_WHEELIE_HOP_FACE_SOUTHEAST 0xEB
#define MOVEMENT_ACTION_ACRO_WHEELIE_HOP_FACE_NORTHWEST 0xEC
#define MOVEMENT_ACTION_ACRO_WHEELIE_HOP_FACE_NORTHEAST 0xED
#define MOVEMENT_ACTION_ACRO_WHEELIE_HOP_SOUTHWEST      0xEE
#define MOVEMENT_ACTION_ACRO_WHEELIE_HOP_SOUTHEAST      0xEF
#define MOVEMENT_ACTION_ACRO_WHEELIE_HOP_NORTHWEST      0xF0
#define MOVEMENT_ACTION_ACRO_WHEELIE_HOP_NORTHEAST      0xF1
#define MOVEMENT_ACTION_ACRO_WHEELIE_JUMP_SOUTHWEST     0xF2
#define MOVEMENT_ACTION_ACRO_WHEELIE_JUMP_SOUTHEAST     0xF3
#define MOVEMENT_ACTION_ACRO_WHEELIE_JUMP_NORTHWEST     0xF4
#define MOVEMENT_ACTION_ACRO_WHEELIE_JUMP_NORTHEAST     0xF5
#define MOVEMENT_ACTION_ACRO_WHEELIE_IN_PLACE_SOUTHWEST 0xF6
#define MOVEMENT_ACTION_ACRO_WHEELIE_IN_PLACE_SOUTHEAST 0xF7
#define MOVEMENT_ACTION_ACRO_WHEELIE_IN_PLACE_NORTHWEST 0xF8
#define MOVEMENT_ACTION_ACRO_WHEELIE_IN_PLACE_NORTHEAST 0xF9
#define MOVEMENT_ACTION_ACRO_POP_WHEELIE_MOVE_SOUTHWEST 0xFA
#define MOVEMENT_ACTION_ACRO_POP_WHEELIE_MOVE_SOUTHEAST 0xFB
#define MOVEMENT_ACTION_ACRO_POP_WHEELIE_MOVE_NORTHWEST 0xFC
#define MOVEMENT_ACTION_ACRO_POP_WHEELIE_MOVE_NORTHEAST 0xFD
#define MOVEMENT_ACTION_ACRO_WHEELIE_MOVE_SOUTHWEST     0xFE
#define MOVEMENT_ACTION_ACRO_WHEELIE_MOVE_SOUTHEAST     0xFF
#define MOVEMENT_ACTION_ACRO_WHEELIE_MOVE_NORTHWEST     0x100
#define MOVEMENT_ACTION_ACRO_WHEELIE_MOVE_NORTHEAST     0x101
#define MOVEMENT_ACTION_ACRO_END_WHEELIE_MOVE_SOUTHWEST 0x102
#define MOVEMENT_ACTION_ACRO_END_WHEELIE_MOVE_SOUTHEAST 0x103
#define MOVEMENT_ACTION_ACRO_END_WHEELIE_MOVE_NORTHWEST 0x104
#define MOVEMENT_ACTION_ACRO_END_WHEELIE_MOVE_NORTHEAST 0x105
#define MOVEMENT_ACTION_RUN_SOUTHWEST_SLOW              0x106
#define MOVEMENT_ACTION_RUN_SOUTHEAST_SLOW              0x107
#define MOVEMENT_ACTION_RUN_NORTHWEST_SLOW              0x108
#define MOVEMENT_ACTION_RUN_NORTHEAST_SLOW              0x109

#define MOVEMENT_ACTION_STEP_END 0xFFFE
#define MOVEMENT_ACTION_NONE     0xFFFF
...
#define ANIM_ENTER_POKEBALL_SOUTH           0
#define ANIM_ENTER_POKEBALL_NORTH           1
#define ANIM_ENTER_POKEBALL_WEST            2
#define ANIM_ENTER_POKEBALL_EAST            3
#define ANIM_ENTER_POKEBALL_FAST_SOUTH      4
#define ANIM_ENTER_POKEBALL_FAST_NORTH      5
#define ANIM_ENTER_POKEBALL_FAST_WEST       6
#define ANIM_ENTER_POKEBALL_FAST_EAST       7
#define ANIM_EXIT_POKEBALL_SOUTH            8
#define ANIM_EXIT_POKEBALL_NORTH            9
#define ANIM_EXIT_POKEBALL_WEST            10
#define ANIM_EXIT_POKEBALL_EAST            11
#define ANIM_EXIT_POKEBALL_FAST_SOUTH      12
#define ANIM_EXIT_POKEBALL_FAST_NORTH      13
#define ANIM_EXIT_POKEBALL_FAST_WEST       14
#define ANIM_EXIT_POKEBALL_FAST_EAST       15
#define ANIM_ENTER_POKEBALL_SOUTHWEST      16
#define ANIM_ENTER_POKEBALL_SOUTHEAST      17
#define ANIM_ENTER_POKEBALL_NORTHWEST      18
#define ANIM_ENTER_POKEBALL_NORTHEAST      19
#define ANIM_ENTER_POKEBALL_FAST_SOUTHWEST 20
#define ANIM_ENTER_POKEBALL_FAST_SOUTHEAST 21
#define ANIM_ENTER_POKEBALL_FAST_NORTHWEST 22
#define ANIM_ENTER_POKEBALL_FAST_NORTHEAST 23
#define ANIM_EXIT_POKEBALL_SOUTHWEST       24
#define ANIM_EXIT_POKEBALL_SOUTHEAST       25
#define ANIM_EXIT_POKEBALL_NORTHWEST       26
#define ANIM_EXIT_POKEBALL_NORTHEAST       27
#define ANIM_EXIT_POKEBALL_FAST_SOUTHWEST  28
#define ANIM_EXIT_POKEBALL_FAST_SOUTHEAST  29
#define ANIM_EXIT_POKEBALL_FAST_NORTHWEST  30
#define ANIM_EXIT_POKEBALL_FAST_NORTHEAST  31
#define ANIM_POKEBALL_COUNT                32
